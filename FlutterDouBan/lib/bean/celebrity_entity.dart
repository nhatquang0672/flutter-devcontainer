...
class CelebrityEntity {
  ...
  factory CelebrityEntity(jsonStr) => jsonStr is String
      ? new CelebrityEntity.fromJson(json.decode(jsonStr))
      : new CelebrityEntity.fromJson(jsonStr);
  ...
  CelebrityEntity.fromJson(jsonRes) {
    ...
    for (var photosItem in photos == null ? [] : jsonRes['photos']) {
      if (photosItem == null) continue;
      photos?.add(new Photo.fromJson(photosItem));
    }
    ...
    for (var worksItem in works == null ? [] : jsonRes['works']) {
      works?.add(new Work.fromJson(worksItem));
    }
...
class Work {
  ...
  Work.fromJson(jsonRes) {
    ...
    subject = jsonRes['subject'] == null
        ? null
        : new WorkSubject.fromJson(jsonRes['subject']);
  }
...
class WorkSubject {
  ...
  WorkSubject.fromJson(jsonRes) {
    ...
    for (var castsItem in casts == null ? [] : jsonRes['casts']) {
      casts?.add(new CastDict.fromJson(castsItem));
    }
...
class Rating {
  ...
  Rating.fromJson(jsonRes) {
    ...
    details = jsonRes['details'] == null
        ? null
        : new Detail.fromJson(jsonRes['details']);
  }
...
class CastDict {
  ...
  CastDict.fromParams(
      {this.alt, this.avatars, this.id, this.name, this.name_en});
